...
- `SELLER_ADDRESS=0x<YOUR_ADDRESS>`
- `SELLER_PRIVATE_KEY=0x<YOUR_PRIVATE_KEY>`
- `BUYER_ADDRESS=0x<YOUR_ADDRESS>`
- `BUYER_PRIVATE_KEY=0x<YOUR_PRIVATE_KEY>`
...
SELLER_ADDRESS=0x...
SELLER_PRIVATE_KEY=0x<YOUR_PRIVATE_KEY>
BUYER_ADDRESS=0xc1E2C96979A08B48FBB1F072e50587299D630560
BUYER_PRIVATE_KEY=0x<YOUR_PRIVATE_KEY>
```
